    ...
    <section className="py-20 px-4" id="how-it-works">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gradient">Simple Process, Powerful Results</h2>
        ...
        <div className="relative">
          <div className="absolute left-1/2 top-1/2 -translate-y-1/2 w-0.5 h-1/2 bg-purple-200 hidden lg:block"></div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            {steps.map((step, index) => (
              <div key={index} className="relative">
                <div className="flex flex-col items-center">
                  <div className="bg-purple-100 rounded-full h-12 w-12 flex items-center justify-center z-10 mb-4">
                    <span className="text-primary text-xl font-bold">{step.number}</span>
                  </div>
                  <div className="glass-card p-8 h-full">
                    <div className="mb-4 flex justify-center">
                      <div className="p-3 bg-secondary inline-flex rounded-lg">
